...
Route::get('/facilities/edit/{business}', [AdminController::class, 'editFacility'])->name('facilities.edit');
Route::patch('/facilities/edit/{business}', [AdminController::class, 'updateFacility'])->name('facilities.update');
